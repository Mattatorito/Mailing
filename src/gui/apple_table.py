...
class AppleTableDelegate(QStyledItemDelegate, ThemedWidget):
    ...
    def paint(self, painter: QPainter, option, index: QModelIndex):
        ...
        painter.drawText(r.adjusted(8,0,-8,0), Qt.AlignVCenter | Qt.AlignLeft, elided)
        # bottom separator
...
class AppleTableView(QTableView, ThemedWidget):
    ...
    def __init__(self, parent=None, theme_manager: ThemeManager | None = None):
        ...
        self.setStyleSheet("QTableView { background: transparent; border: none; }"
                           ...
                           "QHeaderView::section { background: transparent; padding:6px 8px; border: none; border-bottom:1px solid rgba(255,255,255,40); }")
