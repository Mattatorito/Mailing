...
.dark #Vibrant { background: rgba(30,30,32,0.25); border: 1px solid rgba(255,255,255,0.08); }
#Sidebar { background: rgba(255,255,255,0.55); border-radius: 18px; }
.dark #Sidebar { background: rgba(30,30,32,0.30); }
QPushButton { border-radius: 10px; padding:7px 16px; background: linear-gradient(180deg, rgba(0,132,255,0.95), rgba(0,102,220,0.90)); color: #fff; border: 1px solid rgba(255,255,255,0.25); font-weight:500; }
QPushButton:hover { background: linear-gradient(180deg, rgba(0,142,255,1.0), rgba(0,112,230,0.95)); }
QPushButton:pressed { background: linear-gradient(180deg, rgba(0,112,230,1.0), rgba(0,92,200,0.95)); }
QPushButton:disabled { background: rgba(120,120,120,0.35); border: 1px solid rgba(255,255,255,0.10); }
