...
from PySide6.QtWidgets import (
    QWidget, QVBoxLayout, QHBoxLayout, QLabel, QComboBox, QSlider, QFrame
)
...
class SettingsPanel(QWidget):
    ...
    def _init_ui(self):
        ...
        title = QLabel(self.lang.t('settings_title'))
        title.setObjectName('settingsTitle')
        layout.addWidget(title)

        # Theme mode
        theme_row = QHBoxLayout()
        theme_label = QLabel(self.lang.t('toggle_theme'))
        self.theme_combo = QComboBox()
        self.theme_combo.addItem(self.lang.t('theme_auto'), 'auto')
        self.theme_combo.addItem(self.lang.t('theme_light'), 'light')
        self.theme_combo.addItem(self.lang.t('theme_dark'), 'dark')
        ...
        lang_label = QLabel(self.lang.t('language_label'))
        ...
        scale_label = QLabel(self.lang.t('ui_scale'))
    ...
    def _on_theme_mode(self):
        mode = self.theme_combo.currentData()
        self.themeModeChanged.emit(mode)

    def _on_scale(self, value: int):
        self.scaleChanged.emit(value / 100.0)

    def retranslate(self):
        # Rebuild static texts (simple approach)
        self.findChild(QLabel, 'settingsTitle').setText(self.lang.t('settings_title'))
