...
def fix_trailing_whitespace(file_path: Path) -> int:
    """Удаляет trailing whitespace из файла."""
...
def fix_multiple_empty_lines(file_path: Path) -> int:
    """Исправляет множественные пустые строки (максимум 2 подряд)."""
...
def fix_long_lines(file_path: Path, max_length: int = 88) -> int:
    """Исправляет слишком длинные строки где это возможно."""
